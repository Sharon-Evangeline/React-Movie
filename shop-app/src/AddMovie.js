...
export function AddMovie(){
    ...
    const movieValidationSchema=yup.object({
        ...
        summary:yup.string().required().min(0).max(10),
        rating:yup.number().required().min(10),
    ...
    return(
        <form className="addForm" onSubmit={formik.handleSubmit}>
            ...
            <TextField id="outlined-basic" label="Poster" variant="outlined" placeholder="Poster" />
            <TextField id="outlined-basic" label="Rating" variant="outlined" placeholder="Rating" />
            <TextField id="outlined-basic" label="Summary" variant="outlined" placeholder="Summary" />
            <TextField id="outlined-basic" label="Trailer" variant="outlined" placeholder="Trailer" />
